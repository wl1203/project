				      ...
				      {					
					     ...
					     verString( "返回");
					           ...
					           {	In_pause=0;           //这很关键，决定再次启动需要重发0x91命令
					             ...
					             {	VTAB=0x70;
						            HTAB=0x00;putString("F1");verString( "继续  "); 
						            HTAB=0x08;putString("       ");	
						            HTAB=0x10;putString("F3");verString( "返回");
					              }
								}
