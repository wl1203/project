...
U32 		Wbuf5460V,Rbuf5460V,Wbuf5460M,Rbuf5460M;
...
{	
	...
	/*volt=(volt>30)?30:(volt<0)?0:volt;
	volt = volt*10;
	sprintf(b,"%03d",(uint16)volt);
	U3THR=0xeb;
	U3THR=0x90;
	U3THR=0x50;
...
函数参数：0         1      2
*********************************************/
void Performance2(uint16 num)  //0x98命令会传入num=1
{	
