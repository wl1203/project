...
char   UR0_R_Buff[256],UR0_T_Buff[256],Voltb[4];
...
{	
	...
	volt = volt*100;
	sprintf(Voltb,"%04d",(int32)volt); 
	U3THR=0xEB;
	U3THR=0x90;
	U3THR=Motor_SW;
	U3THR=(uint8)(Voltb[0]&0x0f);
	U3THR=(uint8)(Voltb[1]&0x0f);
	U3THR=(uint8)(Voltb[2]&0x0f);
	U3THR=(uint8)(Voltb[3]&0x0f);
